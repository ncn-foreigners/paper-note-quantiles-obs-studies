...
Install relevant packages for the paper. The `jointCalib` package is available at CRAN but we install the package from github (development version)

```{r install-package}
#install.packages(c("remotes", "ebal", "mvnfast", "data.table", "ggplot2", "laeken"))
