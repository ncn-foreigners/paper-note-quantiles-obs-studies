...
colnames(results_ks) <- colnames(results_ks) <- colnames(results) <- c("IPS (exp)", "IPS (ind)", "IPS (proj)", 
                                                                     "CPBS (e)", "CBPS (o)",
                                                                     "CBPS (e MQ)", "CBPS (o MQ)", 
                                                                     "CBPS (e MP)",  "CBPS (o MP)",
                                                                     "CPBS (e P)", "CPBS (o P)")
...
colnames(results2_ks) <- colnames(results2_ks) <- colnames(results2) <- c("IPS (exp)", "IPS (ind)", "IPS (proj)", 
                                                                     "CPBS (e)", "CBPS (o)",
                                                                     "CBPS (e MQ)", "CBPS (o MQ)", 
                                                                     "CBPS (e MP)",  "CBPS (o MP)",
                                                                     "CPBS (e P)", "CPBS (o P)")
...
for (i in 1:reps) {
  ...
  suppressWarnings(qte_IPS_exp <- IPS::QTE(data_sim1$Y, 
                                           data_sim1$Treat, xcov, 
                                           fit.ind$fitted.values,
                                           fit.ind$lin.rep, tau, bw = bw))
