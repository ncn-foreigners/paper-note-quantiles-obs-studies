...
sim2$ATE |> 
  ...
  transform(quant = factor(quant, 
            ...
            est = factor(est,
                         ...
                         c("IPS (exp)", "IPS (ind)", "IPS (proj)", 
                           "CBPS (e)", "DBPS (e MQ)", "DBPS (e MD)", "DBPS (e D)", 
                           "CBPS (o)", "DBPS (o MQ)", "DBPS (o MD)", "DBPS (o D)"))) -> sim2_results2
...
sim1$ATE |> 
  ...
  transform(quant = factor(quant, 
            ...
            est = factor(est,
                         ...
                         c("IPS (exp)", "IPS (ind)", "IPS (proj)", 
                           "CBPS (e)", "DBPS (e MQ)", "DBPS (e MD)", "DBPS (e D)", 
                           "CBPS (o)", "DBPS (o MQ)", "DBPS (o MD)", "DBPS (o D)")))-> sim2_results1
...
sim2$CVM |> 
  ...
  transform(variable = factor(variable,
                         ...
                         c("IPS (exp)", "IPS (ind)", "IPS (proj)", 
                           "CBPS (e)", "DBPS (e MQ)", "DBPS (e MD)", "DBPS (e D)", 
                           "CBPS (o)", "DBPS (o MQ)", "DBPS (o MD)", "DBPS (o D)"))) #|>
  ## uncomment for xtable
  #xtable() 
```
